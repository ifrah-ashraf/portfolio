...
const achievements: Achievement[] = [
    ...
    },
    {
        ...
        subtitle: "GitHub Projects · 2025 – Present",
        description: "Actively contributing to production open-source projects used by thousands of developers worldwide.",
        date: "2023 – Present",
        tags: ["Open Source", "monorepo", "Node.js"],
        color: "cyan",
        contributions: [
            { name: "cal.com", url: "https://github.com/calcom/cal.com/commits/main/?author=ifrah-ashraf", initials: "cal" },
        ],
    },
    {
        icon: "🤖",
